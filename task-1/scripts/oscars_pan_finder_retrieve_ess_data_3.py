...
# # OSCARS PaN-Finder
# ## Retrieve all publicly accessible and published data from data provider: ESS
# 
# All data is directly retrieved from ESS SciCat instance
# 
# Version: 3.0
...
data_provider_url = "https://scicat.ess.eu/api/v3"
data_provider_url
...
output_data_file = os.path.abspath("../data/ess_open_data_" + datetime.datetime.now().strftime("%Y%m%d%H%M%S%f") + ".json")
output_data_file
